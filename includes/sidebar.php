            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="<?php echo $qb_url_root?>/question/question.php"><i class="fa fa-graduation-cap"></i> <?=get_string('question_title') ?> </a> </li>
                  <li><a href="<?php echo $qb_url_root?>/zujuan/testpapers.php"><i class="fa fa-pencil-square-o"></i> <?=get_string('testpapers'); ?> </a> </li>
                  <li><a href="<?php echo $qb_url_root?>/zujuan/zujuan.php"><i class="fa fa-pencil-square-o"></i> <?=get_string('manualzujuan'); ?> </a> </li>
                  <li><a href="<?php echo $qb_url_root?>/question/zujuan.php"><i class="fa fa-pencil-square-o"></i> old组卷 </a> </li>
