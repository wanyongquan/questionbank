...
$responseAr['data']= array(["david", "beckham", "<a onclick='deletebtn(this)'>delete</a>"],["paul", "scholes","<a click='delete(this)'>delete</a>"],["Roy", "Keane","<a click='delete(this)'>delete</a>"]);
if (isset($d)){
