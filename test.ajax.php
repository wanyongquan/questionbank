...
$responseAr['data']= array(["david", "beckham", "<div class='hello'><a  class='btn  btn-primary ' onclick='deletebtn(this)'>delete</a>"],["paul", "scholes","<a class='btn  btn-primary'>delete</a>"],["Roy", "Keane","<a click='delete(this)'>delete</a></div>"]);
if (isset($d)){
